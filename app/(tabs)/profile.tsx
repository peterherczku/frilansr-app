...
import {ProfileSettingsBox, ProfileSettingsBoxItem} from "@/components/ui/profile/ProfileSettingsBox";
    ...
    return (
        <SafeAreaView style={styles.safeContainer}>
            ...
            <ScrollView>
                <ProfileHeader />
                <ProfilePaymentBox>
                    <ProfilePaymentBoxItem title={"Payment history"} subtitle={"15 payments"} />
                    <View style={{height: 2, backgroundColor: "#ECECEC", borderRadius: 8}} />
