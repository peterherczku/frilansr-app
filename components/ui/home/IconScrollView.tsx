...
const categories = [
    ...
    },
    {
        id: 1,
        name: "Offices",
        icon: <MaterialCommunityIcons name="office-building" size={40} color="black" />
    },
    {
        id: 2,
        name: "Education",
...
export function IconScrollView({}) {
    ...
    return <View>
        <FlatList showsHorizontalScrollIndicator={false} keyExtractor={(item) => item.id} horizontal={true} data={categories} renderItem={renderItem} />
    </View>
}
