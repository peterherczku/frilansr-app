...
export function ProfileAffiliateProgram() {
	return (
		...
		>
			<View>
				<Text className="font-zain-bold text-[17] ">
			...
			<View className="flex-row items-center justify-between">
				<View className="flex-row items-center">
					...
					<Text className="zain-bold text-theme mt-[1.5] ml-[5] text-[17]">
						3/5
					</Text>
				</View>
				<TouchableOpacity>
					<Text className="font-zian-bold text-theme underline text-[17]">
						Invite your friends
					</Text>
				</TouchableOpacity>
			</View>
